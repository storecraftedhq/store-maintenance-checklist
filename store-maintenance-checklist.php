 ...
 * Plugin URI:        https://storecrafted.com
 ...
 * Text Domain:       store-maintenance-checklist
		...
		if ( ! class_exists( 'WooCommerce' ) ) {
			add_action(
				...
				static function (): void {
					...
					esc_html_e( 'Store Maintenance Checklist for WooCommerce requires WooCommerce.', 'store-maintenance-checklist' );
					echo '</p></div>';
				},
				10,
				0

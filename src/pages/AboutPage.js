...
export default function AboutPage( { onNavigate } ) {
	...
	const actions = (
		<>
			...
			>
				{ __( 'storecrafted.com', 'store-maintenance-checklist' ) }
			</a>
			<button
				type="button"
				...
				onClick={ () => onNavigate( '/' ) }
			>
				{ __( 'Open Checklist', 'store-maintenance-checklist' ) }
			</button>
		</>
	);
	...
	return (
		<Canvas
			title={ __( 'About', 'store-maintenance-checklist' ) }
			meta={ __(
		...
		>
			...
			<div className="stmc-settings-actions">
				<button
					...
					onClick={ () => onNavigate( '/' ) }
				>
					{ __( 'Back to Checklist', 'store-maintenance-checklist' ) }
				</button>
			</div>

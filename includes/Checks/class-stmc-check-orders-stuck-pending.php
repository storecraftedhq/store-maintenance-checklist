...
final class STMC_Check_Orders_Stuck_Pending extends STMC_Check_Base {
	...
	public function title(): string {
		return __( 'Orders stuck in Pending payment', 'store-maintenance-checklist' );
	}
	...
	public function evaluate( STMC_Check_Snapshot $snapshot ): array {
		...
		return $this->open(
			$snapshot,
			__( 'Payment or ops backlog: pending payment orders older than 7 days.', 'store-maintenance-checklist' ),
			array(
				'summary' => __( 'pending payment orders older than 7 days.', 'store-maintenance-checklist' ),
				'count'   => $count,
